...
public class Query {
    public String logistics(String com, String num){
        ...
        String customer ="008136A33C31F8316AD84B3400B45730";
        String key = "hKXHrytX8810";
        ...
        String resp;
        try {
            resp = new HttpRequest().postData("https://poll.kuaidi100.com/poll/query.do", params, "utf-8").toString();
